...
<body>
	<div style="width:1100px;margin:50px auto 0;">
      <div class="forget2">
           <div style="text-align:center"><span style="font-size:20px">查询员工</span></div><br>
            <form action="LInquire" method="post">
				<span style="font-size:16px;">请输入您要查询的ID:<input type="text"  name="ID" ></span>
                <br>
